...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Netfold" },
      { property: "og:description", content: BRAND.tagline },
      { property: "og:url", content: "https://www.netfold.site" },
      { property: "og:image", content: "https://www.netfold.site/og.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Netfold" },
      { name: "twitter:description", content: BRAND.tagline },
      { name: "twitter:image", content: "https://www.netfold.site/og.jpg" },
    ],
    links: [
